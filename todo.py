...
root.iconbitmap("C:/Users/NipunBatra/Pictures/Saved Pictures/light bulb.ico")
root.geometry("1700x900+110+50")
...
def add_item():
    string_entry = my_entry.get()
    if string_entry.isspace() == True:
        my_entry.delete(0, END)
    else:
        my_list.insert(END, my_entry.get().strip())
        my_entry.delete(0, END)

keyboard.add_hotkey('enter', add_item)
...
def save_list():
	file_name = filedialog.asksaveasfilename(
		initialdir="C:/Users/NipunBatra/Coding/lists",
		title="Save File",
		filetypes=(
			("Dat Files", "*.dat"), 
			("All Files", "*.*"))
